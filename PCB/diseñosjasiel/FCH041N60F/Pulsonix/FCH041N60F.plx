...
(library Library_1
	...
	(patternDef "TO556P482X1562X2475-3P" (originalName "TO556P482X1562X2475-3P")
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.375 2.955) (pt 13.495 2.955) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 13.495 2.955) (pt 13.495 -1.865) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 13.495 -1.865) (pt -2.375 -1.865) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.375 -1.865) (pt -2.375 2.955) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.375 0.175) (pt 0.405 2.955) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "FCH041N60F" (originalName "FCH041N60F") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "<Hyperlink>" "https://www.onsemi.com/pub/Collateral/FCH041N60F-D.pdf")
		(attr "<Component Height>" "4.82")
		(attr "<STEP Filename>" "FCH041N60F.stp")
